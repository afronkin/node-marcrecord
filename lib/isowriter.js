 ...
 */
MarcIsoWriter.prototype.openFile = function(recordsFile, encoding) {
...
MarcIsoWriter.prototype.open = function(recordsFileName, encoding, callback) {
  ...
  fs.open(recordsFileName, 'a+', function(err, recordsFile) {
    ...
    self.openFile(recordsFile, encoding);
    callback();
  });
}
 ...
 */
MarcIsoWriter.prototype.openSync = function(recordsFileName, encoding) {
  var recordsFile = fs.openSync(recordsFileName, 'a+');
  this.openFile(recordsFile, encoding);
}
...
MarcIsoWriter.prototype.write = function(record, callback) {
  ...
  var recordBufferSize =
    MarcIsoWriter.recordToIso2709(record, recordBuffer, self.encoding);
