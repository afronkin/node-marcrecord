...
function MarcControlField(tag, data) {
  ...
  if (tag instanceof MarcControlField || tag instanceof Object) {
...
function MarcDataField(tag, ind1, ind2) {
  ...
  if (tag instanceof MarcDataField || tag instanceof Object) {
    // Copy the source field.
    var srcField = tag;
    this.tag = srcField.tag;
